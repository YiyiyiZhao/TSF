...
for kk in keys:
    ...
    models = [PatchTST(h=horizon,input_size=6,scaler_type='standard', max_steps=700,batch_size=4,patch_len=12,learning_rate=5e-4,stride=12)]
    ...
    #Future
    models = [PatchTST(h=23,input_size=6, scaler_type='standard',max_steps=700,batch_size=4,patch_len=12,learning_rate=5e-4, stride=12)]
    nf = NeuralForecast(models=models, freq='MS')
    nf.fit(df=df)
